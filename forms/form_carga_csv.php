...
<div class="container mt-5">  
  ...
  <div class='row justify-content-end mt-2'>
    <button class='col-1 btn btn-success' style='width:200px; font-size:20px;' type='button' id='btn_send_all'> Enviar todo
    ...
    <button class='col-1 mx-3 btn btn-primary' style='width:200px; font-size:20px;' type='button' id='btn_send_bd'>Cargar todo
...
<script src="../js/forms/form_carga.js"  type='module'></script>
</html>
